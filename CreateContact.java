...
public class CreateContact {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("firstNameField")).sendKeys("Janu");
		driver.findElement(By.id("lastNameField")).sendKeys("Mittu");
		driver.findElement(By.id("createContactForm_firstNameLocal")).sendKeys("Janu");
		driver.findElement(By.id("createContactForm_lastNameLocal")).sendKeys("Mittu");
		
		//Input Department, Description and email boxes
		driver.findElement(By.id("createContactForm_departmentName")).sendKeys("HumanResource");
		driver.findElement(By.id("createContactForm_description")).sendKeys("This is new Create contact form");
		driver.findElement(By.id("createContactForm_primaryEmail")).sendKeys("mittu@gmail.com");
